...
@section('script')
<script>
	var emailBounceCount="{{$emailBounceCount}}";
	var leadCount="{{$leadCount}}";
	var duplicateLeadCount="{{$duplicateLeadCount}}";
	var emailunsubscribe="{{$emailunsubscribe}}";
</script>
<script src="{{ url('public/admin/assets/js/apexcharts.js') }}"></script>
@endsection